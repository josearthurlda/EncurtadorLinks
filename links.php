          ...
          echo '
            <div class="card text-center p-2">
                ...
                <div class="card-body">
                    ...
                    <a id='.$row['id'].' href="?id='.$row['link_curto'].'" class="btn btn-primary">Ir ao destino</a>
                    <button onclick="copiar('.$row['id'].')" class="btn btn-success"><i class="bi bi-clipboard"></i> Copiar Link</button>
                </div>
